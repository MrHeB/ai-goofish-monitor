const enUSExtra = {
  ...
  accounts: {
    ...
    description: 'Scan with the Goofish app to log in and save the login state automatically.',
    add: '+ Scan to Add Account',
    addManual: '+ Add JSON Manually',
    cookieGuide: {
      title: 'Add an Account (Scan Login Recommended)',
      step1: 'Click "+ Scan to Add Account" in the top-right corner and enter an account name.',
      step2: 'Scan the QR code with the Goofish app and confirm the login on your phone.',
      step3: 'The login state is saved automatically once you are signed in. The account is now ready.',
      fallbackHint: 'If scan login is unavailable (e.g. risk control requires phone verification), use "+ Add JSON Manually" to paste the login state extracted by the extension.',
    },
    list: {
      title: 'Account List',
    ...
    qr: {
      title: 'Scan to Add a Goofish Account',
      description: 'Enter an account name to generate a QR code, then scan it with the Goofish app.',
      name: 'Account Name',
      namePlaceholder: 'Example: acc_1',
      start: 'Generate QR Code',
      generating: 'Generating QR code...',
      waiting: 'Scan the QR code with the Goofish app',
      scanned: 'Scanned. Confirm the login on your phone.',
      success: 'Login successful. Account saved.',
      expired: 'QR code expired. Please regenerate.',
      cancelled: 'Login cancelled.',
      verificationRequired: 'Account is under risk control. Complete the verification on your phone.',
      createFailed: 'Failed to generate QR code.',
      sessionLost: 'Login session expired. Please regenerate.',
      regenerate: 'Regenerate',
      hint: 'The QR code is valid for 5 minutes. The login state is saved to the account file automatically.',
    },
    createDialog: {
      title: 'Add Goofish Account Manually',
    ...
    toasts: {
      ...
      incomplete: 'Incomplete information',
      nameRequired: 'Please provide an account name.',
      ...
      authorizeFailed: 'Failed to authorize account.',
    },
  },
  notifyPanel: {
